...
def load_model_checkpoint(model, model_checkpoint_path, optimizer=None, mode='test'):
    ...
    if mode == 'test':
        ...
        print('Resume from checkpoint at Iteration %d (ACC %f)...' % (start_iter, start_iou))
